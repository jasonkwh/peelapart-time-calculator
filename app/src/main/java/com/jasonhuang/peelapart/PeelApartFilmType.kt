...
enum class PeelApartFilmType(val temperatures: DoubleArray, val times: IntArray) {
    FP100B(doubleArrayOf(10.0, 15.0, 18.0, 20.0, 24.0, 35.0), intArrayOf(90, 60, 50, 40, 30, 30)),
    ...
    FP100B45(doubleArrayOf(10.0, 15.0, 18.0, 20.0, 24.0, 35.0), intArrayOf(90, 60, 50, 40, 30, 30)),
    FP100C45(doubleArrayOf(10.0, 15.0, 20.0, 25.0, 30.0, 35.0), intArrayOf(270, 180, 120, 90, 75, 60))
}